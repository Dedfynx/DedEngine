...
namespace DedOs{
	Model::Model(Device& device, const Model::Data& builder)
		: hDevice{device}
	{
	...
	void Model::createVertexBuffers(const std::vector<Vertex>& vertices)
	{
		...
		hDevice.copyBuffer(stagingBuffer.getBuffer(), vertexBuffer->getBuffer(), bufferSize);
	...
	void Model::createIndexBuffers(const std::vector<uint32_t>& indices) {
		...
		hDevice.copyBuffer(stagingBuffer.getBuffer(), indexBuffer->getBuffer(), bufferSize);
	}
	...
	//Struct Data
	void Model::Data::loadModel(const std::string& filename) {
